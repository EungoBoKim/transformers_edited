...
def _is_punctuation(char):
    ...
    57 9
    """
    #if (cp >= 33 and cp <= 47) or (cp >= 58 and cp <= 64) or (cp >= 91 and cp <= 96) or (cp >= 123 and cp <= 126) or cp == 12685 or cp == 4510 or (cp >= 9312 and cp <= 10247):
    if not (cp >= 44032 and cp <= 55203) and not (cp >= 97 and cp <= 122) and not (cp >= 65 and cp <=90) and not (cp >=48 and cp <= 57):
        return True
    cat = unicodedata.category(char)
    if cat.startswith("P"):
        return True
